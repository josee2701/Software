document.getElementById('exportExcelBtn').addEventListener('click', async () => {
    ...
    const url = `${languagePrefix}/whitelabel/company/export-company${queryParam}`;
    ...
    try {
        ...
        data.data.forEach(item => {
            wsData.push([
                ...
                item.actived ? translations.true : translations.false,
            ]);
        });

        const ws = XLSX.utils.aoa_to_sheet(wsData);
        const sheetName = translations.company || "List_Company";
