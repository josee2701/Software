document.getElementById('exportExcelBtn').addEventListener('click', async () => {
    ...
    const url = `${languagePrefix}/checkpoints/drivers/export-drivers${queryParam}`;
    ...
    try {
        ...
        data.data.forEach(item => {
            wsData.push([
                item.personal_identification_number,
                item.company,
                item.first_name,
                item.last_name,
                item.phone_number,
        ...
        const sheetName = translations.driver || "List_Driver";
